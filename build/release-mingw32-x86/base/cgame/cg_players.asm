...
proc CG_RegisterClientModelname 148 16
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
RETI4
LABELV $284
endproc CG_RegisterClientModelname 148 16
proc CG_LoadClientInfo 80 12
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
LTI4 $344
LABELV $307
endproc CG_LoadClientInfo 80 12
...
proc CG_PrecacheClientInfo 1516 12
ADDRLP4 1512
CNSTI4 1508
ASGNI4
ADDRLP4 1508
...
pop
LABELV $373
endproc CG_PrecacheClientInfo 1516 12
proc CG_StatusMessages 56 16
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $389
LABELV $383
endproc CG_StatusMessages 56 16
...
proc CG_SetLerpFrameAnimation 20 8
ADDRFP4 4
ADDRFP4 4
INDIRP4
ASGNP4
...
LABELV $442
LABELV $437
endproc CG_SetLerpFrameAnimation 20 8
...
ASGNB 12
LABELV $888
endproc CG_Player 788 28
export CG_Corpse
proc CG_Corpse 524 24
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
proc CG_GetPlayerLocation 36 8
ADDRLP4 24
CNSTP4 0
ASGNP4
ADDRLP4 8
...
RETP4
LABELV $1263
endproc CG_GetPlayerLocation 36 8
import gettext
import Gettext
import trap_Gettext
